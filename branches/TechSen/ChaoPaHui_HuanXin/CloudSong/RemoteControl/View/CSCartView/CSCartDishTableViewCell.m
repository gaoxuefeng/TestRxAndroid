...
- (void)setupSubViews
{
    ...
    priceLabel.textColor = HEX_COLOR(0xee29a7);
    ...
    bottomDivider.backgroundColor = HEX_COLOR(0x533778);
...
- (void)setItem:(CSDishModel *)item
{
    ...
    self.priceLabel.text = [NSString stringWithFormat:@"￥%@",[NSString stringWithFloat:_item.price]];
