...
- (void)setUserInfo:(CSUserInfoModel *)userInfo
{
    ...
    [_iconView sd_setImageWithURL:[NSURL URLWithString:userInfo.headUrl] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
...
- (void)setSelectedId:(NSString *)selectedId
{
    ...
    {
        _selectedId = [self.myRooms.firstObject reserveBoxId];
