...
- (void)setupCodeView
{
    ...
    codeView.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.04];
...
//    phoneNumTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入手机号码" attributes:@{NSForegroundColorAttributeName: HEX_COLOR(0x4e4e54)}];
    ...
    phoneNumTextField.textColor = HEX_COLOR(0x9893a0);
...
- (void)setupPwdView
{
    ...
    _pwdView = pwdView;
    pwdView.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.04];
    ...
    pwdTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入新密码" attributes:@{NSForegroundColorAttributeName: HEX_COLOR(0x9893a0)}];
