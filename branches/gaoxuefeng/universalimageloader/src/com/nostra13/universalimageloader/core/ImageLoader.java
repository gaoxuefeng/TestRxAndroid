...
public class ImageLoader {
	 ...
	 *            from configuration} will be used.
	 * @param targetSize
	 *            {@linkplain ImageSize} Image target size. If <b>null</b> -
	...
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options, ImageSize targetSize, ImageLoadingListener listener,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey, options, listener,
