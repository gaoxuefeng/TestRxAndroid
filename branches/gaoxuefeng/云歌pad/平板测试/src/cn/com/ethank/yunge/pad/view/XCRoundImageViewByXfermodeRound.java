 ...
 * 这个用来做圆角矩形的
 */
public class XCRoundImageViewByXfermodeRound extends ImageView {
	...
	// 构造方法
	public XCRoundImageViewByXfermodeRound(Context context) {
		this(context, null);
	}

	public XCRoundImageViewByXfermodeRound(Context context, AttributeSet attrs) {
		super(context, attrs);
