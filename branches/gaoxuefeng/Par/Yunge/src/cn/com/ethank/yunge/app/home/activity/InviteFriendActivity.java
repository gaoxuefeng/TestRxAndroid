...
public class InviteFriendActivity extends BaseActivity implements OnClickListener {
	...
	@ViewInject(R.id.invite_tv_context)
	private TextView invite_tv_context;
	...
	private void initView() {
		...
		String ktvName = getIntent().getStringExtra("ktvName");

		invite_tv_context.setText("来来来，K歌聚起来！我在潮趴汇上预订了" + ktvName + "K歌活动,诚邀各位参与!");
		String content = opinion_et.getText().toString();
		// 分享到新浪
		com.umeng.socialize.utils.Log.LOG = true;
		// 设置分享内容
		mController.setShareContent(content + "来来来，K歌聚起来！我在潮趴汇上预订了" + ktvName + "K歌活动,诚邀各位参与!" + Constants.hostUrlCloud
				+ "html/market/invite-ktv.html?" + getIntent().getStringExtra(SharePreferenceKeyUtil.reserveBoxId));
		// 设置分享图片, 参数2为图片的url地址
		mController.setShareImage(new UMImage(getApplicationContext(), R.drawable.ic_launcher));
