...
public class MusicStyleAdapter extends BaseAdapter {
	...
	public MusicStyleAdapter(Context context, ArrayList<MusicStyleBean> musicStyleList) {
		...
		this.musicStyleList = musicStyleList;
		 imageLoader = ImageLoaderUtil.CreatImageLoader(context);
	}
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			viewHolder.iv_music_style = (CubeImageView) view.findViewById(R.id.iv_music_style);
		...
		viewHolder.iv_music_style.loadImage(imageLoader, musicStyleBean.getImageSrc());

		if (mythreeSong.size() == 3) {
			viewHolder.tv_music_type_one.setText(mythreeSong.get(0).getSongName());
			viewHolder.tv_music_type_two.setText(mythreeSong.get(1).getSongName());
			viewHolder.tv_music_type_three.setText(mythreeSong.get(2).getSongName());
	...
	class ViewHolder {
		...
		TextView tv_music_style, tv_music_type_one, tv_music_type_two, tv_music_type_three, tv_1, tv_2, tv_3;
		public CubeImageView iv_music_style;
