...
public class ChooseCityAdapter2 extends BaseAdapter implements SectionIndexer, PinnedHeaderAdapter, OnScrollListener {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		final LinearLayout ll_city_layout = (LinearLayout) view.findViewById(R.id.ll_city_layout);
		final LinearLayout linear_header = (LinearLayout) view.findViewById(R.id.linear_header);
		if (position == 0) {
			ll_city_layout.setVisibility(View.GONE);
			...
			ll_city_layout.setVisibility(View.VISIBLE);
	...
	public int getPinnedHeaderState(int firstPosition) {
	 ...
	 //放开这儿就可以在头部显示字母
	 @Override
	 public void configurePinnedHeader(View header, int firstPosition, int
	 alpha) {
		 ((TextView) header.findViewById(R.id.header)).setText("");
//	 // 根据第一个位置选择首字母
//	 int realPosition = firstPosition;
//	 String title;
//	 if (realPosition != 0) {
