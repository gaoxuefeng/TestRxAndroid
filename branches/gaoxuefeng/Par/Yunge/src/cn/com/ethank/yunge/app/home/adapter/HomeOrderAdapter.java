...
public class HomeOrderAdapter extends BaseAdapter {
	...
	public HomeOrderAdapter(Context context, List<HomeInfo> homeInfos) {
		...
		imageLoader = ImageLoaderUtil.CreatImageLoader(context, true, R.drawable.ktvbgj);
	}
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			// ktv图片
			viewHolder.iv_reserve_image = (CubeImageView) view.findViewById(R.id.iv_reserve_image);
		...
		// Bitmap bitmap = pictureManager.getmenuLogo(imageUrl, false,
		// downloadFinished);
		// if (bitmap != null) {
		// viewHolder.iv_reserve_image.setImageBitmap(bitmap);
		// }
		viewHolder.iv_reserve_image.loadImage(imageLoader, imageUrl);
	...
	public class ViewHolder {
		...
		CubeImageView iv_reserve_image;
