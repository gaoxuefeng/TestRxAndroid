...
public class MasterAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.iv_mastername = (ImageView) convertView.findViewById(R.id.iv_mastername);
		...
		if (selectedPosition == position) {
			...
			convertView.setBackgroundColor(Color.parseColor("#0AFFFFFF"));
		}
		// 显示区名
	...
	class ViewHolder {
		...
		public ImageView iv_mastername;
