...
public class ActivityTypeAdapter extends BaseAdapter {
	...
	public ActivityTypeAdapter(Activity activity, List<ActivityTypeBean> activityTypeBeanList) {
		...
		imageLoader = ImageLoaderUtil.CreatImageLoader(activity, true, R.drawable.home_await_button);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.iv_actiivty_type = (CubeImageView) convertView.findViewById(R.id.iv_actiivty_type);
		...
		viewHolder.iv_actiivty_type.loadImage(imageLoader, activityTypeBean.getIconPath());
	...
	class ViewHolder {
		...
		public CubeImageView iv_actiivty_type;
