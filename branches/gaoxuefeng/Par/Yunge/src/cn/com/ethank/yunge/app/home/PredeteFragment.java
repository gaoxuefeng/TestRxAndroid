...
public class PredeteFragment extends BaseFragment implements View.OnClickListener, OnNetworkChangedListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		contentView = inflater.inflate(R.layout.activity_order_list, container, false);
	...
	private void setNetWork() {
		...
		mrlv_order_list = (MyRefreshListView) contentView.findViewById(R.id.mrlv_order_list);
		...
		tabCity.SetOnTabTextChangeListener(new TabTextChangeListener() {
			...
			public void changeBottomTab(String cityName) {
				...
				if (cityName != null && !cityName.isEmpty()) {
					SharePreferencesUtil.saveStringData(SharePreferenceKeyUtil.currentCity, cityName);
				}
	...
	private void initTab(View view) {
		...
		String currentDefaultCity = SharePreferencesUtil.getStringData(SharePreferenceKeyUtil.currentCity, "北京");
	...
	private void requestHomeInfoNetwork(final boolean isFirstTime) {
		...
		requestHomeInfoNetwork(isFirstTime, locationCity, Constants.latitude + "", Constants.longitude + "");
	...
	private void requestHomeInfoNetwork(final boolean isFirstTime, String city, String latitude, String longitude) {
		...
		// 每次请求10条数据
		// 商圈名称
		if (tabNearby != null && !tabNearby.getTabName().equals("附近") && !tabNearby.getTabName().equals("附近（智能范围）") && !tabNearby.equals("全部商圈")) {
