...
public class ActivityBean implements Serializable {
	...
	public boolean isCurrentCity() {
		if (!TextUtils.isEmpty(Constants.locationCity) && getCityName().equals(Constants.locationCity)) {
			return true;
		}
		return false;
	}
	...
	public String getShowCityName() {
		...
		if (isCurrentCity() && getDistance() != 0) {
			return "附近";
		}
		return getCityName();
	}
	...
	public String getShowCityNameAndTag() {
		...
		return getShowCityName() + " · " + getActivityTag();
	}
