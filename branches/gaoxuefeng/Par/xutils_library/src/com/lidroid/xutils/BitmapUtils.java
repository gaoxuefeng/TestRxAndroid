...
public class BitmapUtils implements TaskHandler {
	...
	public <T extends View> void display(T container, String uri, int defaultDrable) {
		display(container, uri, null, null, defaultDrable);
	}
	...
	public <T extends View> void display(T container, String uri, BitmapDisplayConfig displayConfig, BitmapLoadCallBack<T> callBack, int defaultDrable) {
		if (container == null) {
			return;
		}
		...
		Drawable loadFailedDrawable = resources.getDrawable(defaultDrable);
		displayConfig.setLoadFailedDrawable(loadFailedDrawable);
		container.clearAnimation();
