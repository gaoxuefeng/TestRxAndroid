...
@property(nonatomic, assign) CSDishPayViewControllerType type;
@end
...
- (void)loadData
{
    ...
    _addressCell.address = [NSString stringWithFormat:@"%@-%@",_data.KTVName,_data.roomName];
}
...
- (void)pushToRoomVc
{
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        if (_type == CSDishPayViewControllerTypeNomal) {
