...
- (void)setDataWithRoomItem:(CSKTVRoomItem *)item {
    ...
    if (item.boxTypeState) {
        [_bookBtn setBackgroundColor:HEX_COLOR(0xee29a7)];
        _bookBtn.enabled = YES;
        
    }else{
        [_bookBtn setBackgroundColor:HEX_COLOR(0x574867)];
        _bookBtn.enabled = NO;
    }
}
...
- (void)setupSubviews {
    ...
    _personCountLabel.textColor = [HEX_COLOR(0xffffff)colorWithAlphaComponent:.6];
    ...
    [bookingBtn setBackgroundColor:HEX_COLOR(0xee29a7)];
    [bookingBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [bookingBtn setTitleColor:[UIColor colorWithWhite:1.0 alpha:0.6] forState:UIControlStateDisabled];
