...
@interface CSInRoomViewController ()<UITableViewDataSource,UITableViewDelegate,CSChatToolBarDelegate,CSChatExtensionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,CSActionSheetDelegate,UIAlertViewDelegate,CSSendDoodleViewControllerDelegate,CSSendFaceViewControllerDelegate>
{
...
//    CSChatMessageModel *chatMessageModel = [[CSChatMessageModel alloc] init];
//    chatMessageModel.type = 2;
//    chatMessageModel.content = @"mofaface1.gif";
//    chatMessageModel.nickName = @"哈哈";
//    
//    CSChatMessageModel *chatMessageModel2 = [[CSChatMessageModel alloc] init];
//    chatMessageModel2.type = 2;
//    chatMessageModel2.content = @"mofaface2.gif";
//    chatMessageModel2.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel3 = [[CSChatMessageModel alloc] init];
//    chatMessageModel3.type = 2;
//    chatMessageModel3.content = @"mofaface3.gif";
//    chatMessageModel3.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel4 = [[CSChatMessageModel alloc] init];
//    chatMessageModel4.type = 2;
//    chatMessageModel4.content = @"mofaface4.gif";
//    chatMessageModel4.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel5 = [[CSChatMessageModel alloc] init];
//    chatMessageModel5.type = 2;
//    chatMessageModel5.content = @"mofaface5.gif";
//    chatMessageModel5.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel6 = [[CSChatMessageModel alloc] init];
//    chatMessageModel6.type = 2;
//    chatMessageModel6.content = @"mofaface6.gif";
//    chatMessageModel6.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel7 = [[CSChatMessageModel alloc] init];
//    chatMessageModel7.type = 2;
//    chatMessageModel7.content = @"mofaface7.gif";
//    chatMessageModel7.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel8 = [[CSChatMessageModel alloc] init];
//    chatMessageModel8.type = 2;
//    chatMessageModel8.content = @"mofaface8.gif";
//    chatMessageModel8.nickName = @"哈哈";
//
//    
//    CSChatMessageModel *chatMessageModel9 = [[CSChatMessageModel alloc] init];
//    chatMessageModel9.type = 2;
//    chatMessageModel9.content = @"mofaface9.gif";
//    chatMessageModel9.nickName = @"哈哈";
//
//    return [NSMutableArray arrayWithArray:@[chatMessageModel,chatMessageModel2,chatMessageModel3,chatMessageModel4,chatMessageModel5,chatMessageModel6,chatMessageModel7,chatMessageModel8,chatMessageModel9]];
    return _messages;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (messageModel.type) {
        ...
        case CSChatMessageTypeMagicFace:
        {
            CSMessageMagicFaceTableViewCell *cell = [CSMessageMagicFaceTableViewCell cellWithTableView:tableView];
            cell.item = messageModel;
            cell.bottomLineHidden = indexPath.row == self.messages.count - 1;
            cell.topLineHidden = indexPath.row == 0;
            return cell;
...
- (void)sendFaceBtnPressed
{
    ...
    sendFaceVc.delegate = self;
    sendFaceVc.title = @"魔法表情";
    CSNavigationController *navVc = [[CSNavigationController alloc] initWithRootViewController:sendFaceVc];
...
#pragma mark - CSSendDoodleViewControllerDelegate
- (void)sendDoodleViewControllerDidFinishDoodleImage:(UIImage *)doodleImage
{
    NSData *imageData = UIImageJPEGRepresentation(doodleImage, 0.1);
    NSString *imageString = [imageData base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
    CSRequest *param = [[CSRequest alloc] init];
    param.picName = [NSString stringWithFormat:@"%.0f%d",[[NSDate date] timeIntervalSince1970],arc4random_uniform(10000)];
    param.msgType = [NSNumber numberWithInteger:CSMessageTypePicture];
...
#pragma mark - CSSendFaceViewController
#pragma mark 发送魔法表情请求
- (void)sendFaceViewControllerDidClickWithName:(NSString *)string
{
    CSRequest *param = [[CSRequest alloc] init];
    param.msgType = [NSNumber numberWithInteger:CSMessageTypeMagicFace];
