...
- (void)setupSubviews {
    ...
    UIView * vodBackView = [[UIView alloc]init];
    vodBackView.backgroundColor = WhiteColor_Alpha_4;
    [self addSubview:vodBackView];
    [vodBackView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self);
        make.right.equalTo(self);
        make.top.equalTo(searchBar.mas_bottom);
        make.height.mas_equalTo(TRANSFER_SIZE(56));
    }];
...
//        make.top.equalTo(searchBar.mas_bottom).offset(TRANSFER_SIZE(9));
        make.centerY.equalTo(vodBackView.mas_centerY);
        make.width.equalTo(self).multipliedBy(1.0/5);
        make.height.mas_equalTo(TRANSFER_SIZE(46));
    }];
...
//        make.top.equalTo(searchBar.mas_bottom).offset(TRANSFER_SIZE(9));
    ...
    CSLog(@"%f",[UIScreen mainScreen].bounds.size.height);
    [_tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.bottom.equalTo(_tableView.superview);
        make.top.equalTo(searchBar.mas_bottom).offset(TRANSFER_SIZE(71));
    }];
