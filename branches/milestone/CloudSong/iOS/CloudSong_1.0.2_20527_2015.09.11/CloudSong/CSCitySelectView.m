...
- (void)setupSubviews {
    ...
    searchBarBgView.backgroundColor = HEX_COLOR(0x1e1033);
    ...
    _tableView.sectionIndexBackgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.04];
...
- (void)showSearchResultWithCities:(NSArray *)cities{
    ...
    for (int i = 0; i < cities.count; i++) {
        ...
        button.backgroundColor = [HEX_COLOR(0xffffff) colorWithAlphaComponent:0.06] ;
