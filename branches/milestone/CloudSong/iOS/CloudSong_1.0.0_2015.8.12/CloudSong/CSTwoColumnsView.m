...
- (NSString *)defaultDistrictInCity:(NSString *)city {
    ...
    if (_columnsData.count > 0) {
        NSDictionary *dict = _columnsData[0];
        if ([dict allKeys].count > 0) {
            result = dict[[dict allKeys][0]][0];
        }
    }
    return result;
}
...
- (void)setupSubviews {
    ...
    _leftTableView.backgroundColor = HEX_COLOR(0x151417);
    ...
    _rightTableView.backgroundColor = HEX_COLOR(0x1c1c20);
    ...
    bottomView.backgroundColor = HEX_COLOR(0x151417);
