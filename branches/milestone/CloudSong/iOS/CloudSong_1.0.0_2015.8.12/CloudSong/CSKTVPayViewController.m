...
//    [SVProgressHUD show];
    if (_payMethodCell.payType == CSPayMethodTypeAlipay) {
        [CSPayTool alipayWithOrderId:_order.reserveBoxId productName:_order.shopName productDescription:_order.boxTypeName price:[_order.price stringValue] callBack:^(NSDictionary *resultDic) {
