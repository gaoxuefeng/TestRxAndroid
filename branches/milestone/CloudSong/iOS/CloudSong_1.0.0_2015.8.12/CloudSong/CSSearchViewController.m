...
- (void)setupSubviews {
    ...
    _songTableView.separatorColor = [[UIColor blackColor] colorWithAlphaComponent:.3];
    _songTableView.separatorInset = UIEdgeInsetsZero;
    [CSUtil hideEmptySeparatorForTableView:_songTableView];
    _songTableView.backgroundColor = HEX_COLOR(0x1c1c20);
    ...
    _singerTableView.separatorColor = [[UIColor blackColor] colorWithAlphaComponent:.3];
    _singerTableView.separatorInset = UIEdgeInsetsZero;
    [CSUtil hideEmptySeparatorForTableView:_singerTableView];
    _singerTableView.backgroundColor = HEX_COLOR(0x1c1c20);
