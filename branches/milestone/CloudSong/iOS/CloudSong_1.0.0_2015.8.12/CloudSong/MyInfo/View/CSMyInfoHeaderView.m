...
#define USER_ICON_RADIOUS TRANSFER_SIZE(30.0)
...
- (void)setupCenterView
{
    ...
    userIconView.image = [UIImage imageNamed:@"mine_default avatar"];
    ...
    userNameLabel.textColor = HEX_COLOR(0xb5b7bf);
    ...
    consLabel.textColor = HEX_COLOR(0x847279);
    consLabel.font = [UIFont systemFontOfSize:TRANSFER_SIZE(15.0)];
    consLabel.text = @"水瓶座";
    ...
    warningLabel.textColor = HEX_COLOR(0x74666d);
    ...
    [loginButton setTitleColor:HEX_COLOR(0x786369) forState:UIControlStateNormal];
...
- (void)setItem:(CSUserInfoModel *)item
{
    ...
    if (item) { // 如果获取到用户信息 说明用户已登录
        ...
        {
            _userIconView.image = [UIImage imageNamed:[_item.gender isEqualToString:@"男"]?@"mine_default_avatar":@"mine_default_avatar_female"];
        }
    ...
    {
        _userIconView.image = [UIImage imageNamed:@"mine_default_avatar"];
