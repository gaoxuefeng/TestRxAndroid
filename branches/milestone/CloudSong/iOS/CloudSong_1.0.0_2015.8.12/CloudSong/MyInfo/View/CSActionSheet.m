...
- (void)setupOptionView
{
    ...
    if (_headerTitle.length > 0) {
        ...
        headerTitleLabel.backgroundColor = HEX_COLOR(0x242424);
    ...
    optionView.backgroundColor = HEX_COLOR(0x212121);
    ...
    for (int i = 0; i < _titles.count; i++) { // 按钮
        ...
        [titleButton setBackgroundImage:[UIImage imageNamed:@"action_sheet_bg"] forState:UIControlStateNormal];
        titleButton.tag = i;
