...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.backgroundColor = HEX_COLOR(0x292929);
        [self setupSubviews];
    }
    return self;
}
...
- (void)setupSubviews
{
    ...
    inputTextField.textColor = HEX_COLOR(0x6c6c6c);
    inputTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"发送文字到屏幕,鼓励下唱歌的小伙伴吧~" attributes:@{NSForegroundColorAttributeName: HEX_COLOR(0x6c6c6c)}];
    inputTextField.backgroundColor = HEX_COLOR(0x303030);
