...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.backgroundColor = HEX_COLOR(0x2a2a2a);
        [self setupSubViews];
...
- (void)setupSubViews
{
    ...
    textField.backgroundColor = HEX_COLOR(0x262626);
...
- (void)confirmBtnOnClick
{
    ...
    if (_overString != nil && _overString.length > 0) {
        self.textField.text = [self.textField.text stringByReplacingOccurrencesOfString:_overString withString:@""];
    }
