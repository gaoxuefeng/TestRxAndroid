...
- (void)setupSubViews
{
    ...
    [orderIdCell mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(orderIdCell.superview).offset(TRANSFER_SIZE(25.0));
    ...
    [phoneNumCell mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(orderIdCell.mas_bottom).offset(topPadding);
        make.left.equalTo(phoneNumCell.superview).offset(AUTOLENGTH(150.0) + padding);
    }];
...
//        make.bottom.equalTo(addressCell.superview).offset(-20.0);
    ...
    [statusLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(statusLabel.superview.mas_right).offset(iPhone6?-33.0:-TRANSFER_SIZE(27.0));
        make.centerY.equalTo(statusLabel.superview.mas_top).offset(iPhone6?33.0:TRANSFER_SIZE(27.0));
    }];
