...
@interface CSLoginViewController ()<UITextFieldDelegate,UIScrollViewDelegate>
{
...
@property(nonatomic, weak) UIView *orLine;
...
- (void)setupInputAreaView
{
    ...
    passwordTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"请输入密码" attributes:@{NSForegroundColorAttributeName: HEX_COLOR(0x4e4e54)}];
...
- (void)setupOrView
{
    ...
    orLine.backgroundColor = HEX_COLOR(0x2b2b2d);
    [_container addSubview:orLine];
    _orLine = orLine;
    [orLine mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(orLine.superview).offset(TRANSFER_SIZE(35.0));
        make.right.equalTo(orLine.superview).offset(-TRANSFER_SIZE(35.0));
    ...
    orLabel.textColor = orLine.backgroundColor;
...
- (void)setupRegisterButton
{
    ...
    registerButton.backgroundColor = HEX_COLOR(0x1e1d21);
    ...
    [registerButton setTitleColor:HEX_COLOR(0xafb1b9) forState:UIControlStateNormal];
    ...
    [registerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.orLine.mas_bottom).offset(TRANSFER_SIZE(14.0));
...
- (void)configRightBarButtonItem
{
    ...
    [forgetPwdButton setTitleColor:HEX_COLOR(0xcd418f) forState:UIControlStateNormal];
