...
- (void)setupSubViews
{
    ...
    refundMoneyTopLine.backgroundColor = HEX_COLOR(0x17161a);
    ...
    refundMoneyBottomLine.backgroundColor = HEX_COLOR(0x17161a);
    ...
    refundTypeBottomLine.backgroundColor = HEX_COLOR(0x17161a);
    ...
    refundCycleBottomLine.backgroundColor = HEX_COLOR(0x17161a);
...
- (void)loadData
{
    _refundMoneyCell.content = @"￥147.00";
