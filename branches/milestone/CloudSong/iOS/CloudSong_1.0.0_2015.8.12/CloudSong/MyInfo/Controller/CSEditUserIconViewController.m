...
- (void)setupIconView
{
    ...
    [_iconView sd_setImageWithURL:[NSURL URLWithString:GlobalObj.userInfo.headUrl] placeholderImage:GlobalObj.userIcon];
...
- (void)iconViewPressed:(UITapGestureRecognizer *)tapGr
{
    if (!self.isSpread) { // 没展开时,展开
        ...
        imageView.image = GlobalObj.userIcon;
