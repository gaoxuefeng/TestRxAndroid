...
//// 云服务器
//#define ServiceCloudURL          @"http://192.168.1.239:8480/ethank-yunge-deploy/"
// KTV服务器
...
#define DiscoveryPlayerProtocol     @"discovery/play.json"
#define DiscoveryPraiseProtocol     @"discovery/praise/add.json"

/******************************* 首页活动相关协议 ****************************/
#define HomeActivitiesProtocol      @"home/activities/get.json"
#define HomeRecommendActivitiesProtocol @"home/recommend/get.json"
/******************************* 活动页相关协议 ****************************/
#define ActivityProtocol            @"home/activities/get.json"
...
//};
typedef NS_ENUM(NSInteger, CSMyCostStatusType) {
    CSMyCostStatusTypeHasPayEnableRefunding = 0,                // 已付款可退款
    CSMyCostStatusTypeHasPayDisableRefunding = 1,               // 已付款不可退款
    CSMyCostStatusTypeInCost = 2,                               // 已支付,活动进行中
    CSMyCostStatusTypeCanceled = 3,                             // 已取消
    CSMyCostStatusTypeNotPay = 4,                               // 未付款
    CSMyCostStatusTypeRefunding = 5,                            // 退款中
    //    CSMyCostStatusTypeDone,                                   // 已完成
...
#define Color_Hex_15_14_17 [UIColor colorWithRed:0x15/255.0 green:0x14/255.0 blue:0x17/255.0 alpha:1]
#define Color_Hex_ff_41_ab [UIColor colorWithRed:0xff/255.0 green:0x41/255.0 blue:0xab/255.0 alpha:1]
#define Color_Hex_b5_b7_bf [UIColor colorWithRed:0xb5/255.0 green:0xb7/255.0 blue:0xbf/255.0 alpha:1]
#define Color_Hex_97_99_a2 [UIColor colorWithRed:0x97/255.0 green:0x99/255.0 blue:0xa2/255.0 alpha:1]
#define Color_Hex_1c_1c_20 [UIColor colorWithRed:0x1c/255.0 green:0x1c/255.0 blue:0x20/255.0 alpha:1]
#endif
