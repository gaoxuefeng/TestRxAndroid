...
- (void)setupSubviews {
    ...
    _nickname.textColor =[HEX_COLOR(0xff00ab)colorWithAlphaComponent:.5];
//    _nickname.text=@"昵称";
    ...
    _titleLabel.textColor = [HEX_COLOR(0xffffff)colorWithAlphaComponent:.9];;
    ...
    _subtitleLabel.textColor = [HEX_COLOR(0xffffff) colorWithAlphaComponent:.5];
