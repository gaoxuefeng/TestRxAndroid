...
- (void)setupSubViews
{
    ...
    titleLabel.textColor = HEX_COLOR(0x6b6c72);
    ...
    bottomLine.backgroundColor = HEX_COLOR(0x19181c);
...
//            make.centerY.equalTo(_subTitleLabel.superview);
            ...
            make.top.equalTo(_subTitleLabel.superview).offset(subPadding);
            make.bottom.equalTo(_subTitleLabel.superview).offset(-subPadding);
        }];
...
//    _topicCell = topicCell;
    ...
    roomCell.subTitleLabel.textColor = HEX_COLOR(0xb5b7bf);
    ...
    shopCell.subTitleLabel.textColor = HEX_COLOR(0xb5b7bf);
    [self addSubview:shopCell];
    _shopCell = shopCell;
    // 地址
    CSOrderInfoViewCell *addressCell = [[CSOrderInfoViewCell alloc] initWithTitle:@"地址"];
    
    addressCell.subTitleLabel.textColor = HEX_COLOR(0xb5b7bf);
...
//    _topicCell.subTitle = item.theme;
    ...
    _shopCell.subTitle = item.shopName;
