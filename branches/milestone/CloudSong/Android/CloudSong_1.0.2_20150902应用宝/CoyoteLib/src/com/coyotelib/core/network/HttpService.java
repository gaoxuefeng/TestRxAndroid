...
public abstract class HttpService {
	 ...
	 */
	final public String fetchStringByPost(URI uri, HttpEntity entity, int timeout, AbstractCoding coding) throws IOException {
	...
	final public String fetchStringByPost(URI uri, Map map, int timeout, AbstractCoding coding) throws IOException {
	 ...
	 * Call this function will notify registered OnHttpResponseListener
	 */
	final public String fetchStringByGet(URI uri, int timeout, AbstractCoding coding) throws IOException {
	 ...
	 */
	public final byte[] fetchBytesByPost(URI uri, Map<String, String> kv) throws IOException {
	...
	public final String fetchStringByPost(URI uri, Map<String, String> kv) throws IOException {
		return fetchStringByPost(uri, mapToEntity(kv), DEFAULT_HTTP_TIMEOUT, defaultCoding());
	}
	...
	public final JSONObject fetchJsonByPost(URI uri, Map<String, String> kv) throws IOException {
		return fetchJsonByPost(uri, mapToEntity(kv), DEFAULT_HTTP_TIMEOUT, defaultCoding());
	}

	public byte[] fetchBytesByGet(URI uri, int timeout, AbstractCoding coding) throws IOException {
	...
	final public byte[] fetchBytesByGet(URI uri, AbstractCoding coding) throws IOException {
	...
	final public byte[] fetchBytesByPost(URI uri, Map<String, String> kv, int timeout, AbstractCoding coding) throws IOException {
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		for (String key : kv.keySet()) {
			nameValuePairs.add(new BasicNameValuePair(key, kv.get(key)));
		}
	...
	final public byte[] fetchBytesByPost(URI uri, HttpEntity entity, int timeout, AbstractCoding coding) throws IOException {
		byte[] bytes = null;
	...
	final public byte[] fetchBytesByPost(URI uri, Map<String, String> kv, AbstractCoding coding) throws IOException {
		return fetchBytesByPost(uri, mapToEntity(kv), DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public byte[] fetchBytesByPost(URI uri, HttpEntity entity, AbstractCoding coding) throws IOException {
		return fetchBytesByPost(uri, entity, DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public String fetchStringByPost(URI uri, Map<String, String> kv, AbstractCoding coding) throws IOException {
		return fetchStringByPost(uri, mapToEntity(kv), DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public String fetchStringByPost(URI uri, HttpEntity entity, AbstractCoding coding) throws IOException {
		return fetchStringByPost(uri, entity, DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public String fetchStringByGet(URI uri, AbstractCoding coding) throws IOException {
		return fetchStringByGet(uri, DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public JSONObject fetchJsonByGet(URI uri, int timeout, AbstractCoding coding) throws IOException {
		String str = fetchStringByGet(uri, timeout, coding);
		return JSON.jsonFromString(str);
	}

	final public JSONObject fetchJsonByGet(URI uri, AbstractCoding coding) throws IOException {
		return fetchJsonByGet(uri, DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public JSONObject fetchJsonByPost(URI uri, HttpEntity entity, int timeout, AbstractCoding coding) throws IOException {
		String str = fetchStringByPost(uri, entity, timeout, coding);
		return JSON.jsonFromString(str);
	}

	final public JSONObject fetchJsonByPost(URI uri, Map<String, String> kv, AbstractCoding coding) throws IOException {
		return fetchJsonByPost(uri, mapToEntity(kv), DEFAULT_HTTP_TIMEOUT, coding);
	}

	final public JSONObject fetchJsonByPost(URI uri, HttpEntity entity, AbstractCoding coding) throws IOException {
	...
	final public HttpResponse fetchResponseByGet(URI uri, int timeout) throws IOException {
		HttpGet get = new HttpGet(uri);
	...
	private HttpResponse getResponse(HttpUriRequest req, int timeout/*
																	 * , boolean
																	 * saveCookies
																	 */) throws IOException {
		...
		client.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, timeout).setParameter(CoreConnectionPNames.SO_TIMEOUT, timeout);
		...
		try {
			...
			throw new IOException(String.format("failed in http: %s", req.getURI().toString()));
		}
	}
