...
import cn.com.ethank.yunge.view.recyleviewpager.CustomDurationScroller;
 ...
 */
public class HomePagerAutoScrollViewPager extends ViewPager {
	...
	public HomePagerAutoScrollViewPager(Context paramContext) {
		super(paramContext);
		init();
	}

	public HomePagerAutoScrollViewPager(Context paramContext, AttributeSet paramAttributeSet) {
	...
	public void setAdapter(PagerAdapter advertPagerAdapter) {
		...
		// 设置指定的点适配器
		super.setAdapter(new HomePagerAdvertImagePagerAdapterDecorator((HomePagerAdvertImagePagerAdapter) advertPagerAdapter));
	}
