...
public class MyRoomAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.iv_userhead = (cn.com.ethank.yunge.app.util.XCRoundImageViewByXfermode) convertView
			...
			holder.tv_jioncount = (TextView) convertView
					.findViewById(R.id.tv_jioncount);
		...
		BaseApplication.bitmapUtils.display(holder.iv_userhead,
				myRoomInfoBean.getReservationAvatarUrl(),
				R.drawable.sing_default_head);
		...
		holder.tv_jioncount.setText("参与人数: " + myRoomInfoBean.getJoinCount()
				+ "人");
...
//				intent.putExtra("lng", 108.95108518068);
	...
	public class ViewHolder {
		RelativeLayout rl;
		cn.com.ethank.yunge.app.util.XCRoundImageViewByXfermode iv_userhead;
