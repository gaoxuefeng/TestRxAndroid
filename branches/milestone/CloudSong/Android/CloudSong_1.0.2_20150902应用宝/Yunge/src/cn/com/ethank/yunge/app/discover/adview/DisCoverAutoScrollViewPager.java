 ...
 */
public class DisCoverAutoScrollViewPager extends ViewPager {
	...
	public DisCoverAutoScrollViewPager(Context paramContext) {
		super(paramContext);
		init();
	}
	...
	public void setAdapter(PagerAdapter advertPagerAdapter) {
		...
		// 设置指定的点适配器
		super.setAdapter(new DisCoverAdvertImagePagerAdapterDecorator(
				(DisCoverAdvertImagePagerAdapter) advertPagerAdapter));
	}
