...
public class WhatIsUpActivity extends BaseActivity implements OnClickListener{
	...
	private void initView() {
		singers_et.setText(getIntent().getStringExtra("introduce"));
		singers_et.setSelection(getIntent().getStringExtra("introduce").length());
	...
	public void onClick(View v) {
		...
		case R.id.head_tv_right:
			...
			map.put("whatIsUp", singers_et.getText().toString());
