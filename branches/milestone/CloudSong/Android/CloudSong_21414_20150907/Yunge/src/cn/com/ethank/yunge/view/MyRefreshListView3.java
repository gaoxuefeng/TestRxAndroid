...
//
//public class MyRefreshListView3 extends PullToRefreshListView {
//
//	protected Mode defaultMode;
//	private TouchLisTener touchListener;
//
//	public MyRefreshListView3(Context context, com.handmark.pulltorefresh.library.PullToRefreshBase.Mode mode,
...
//	}
//
//	public MyRefreshListView3(Context context, AttributeSet attrs) {
//		super(context, attrs);
//		initView(context);
//	}
//
//	public MyRefreshListView3(final Context context) {
//		super(context);
//
//		initView(context);
//	}
...
//		this.setOnLastItemVisibleListener(null);
//		// this.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
//		//
//		// @Override
//		// public void onLastItemVisible() {
//		// if (!isRefreshing() && true && (getMode() == Mode.PULL_FROM_END ||
//		// getMode() == Mode.PULL_UP_TO_REFRESH || getMode() == Mode.BOTH)) {
//		// defaultMode = getMode();
//		//
