...
public class ActivityTypeAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.iv_actiivty_type = convertView.findViewById(R.id.iv_actiivty_type);
		...
		if (position == 0) {
			BaseApplication.bitmapUtils.display(viewHolder.iv_actiivty_type, activityTypeBean.getRequestUrl(), R.drawable.home_city_button);
		} else if (position == 1) {
			BaseApplication.bitmapUtils.display(viewHolder.iv_actiivty_type, activityTypeBean.getRequestUrl(), R.drawable.home_star_button);
		} else if (position == 2) {
			BaseApplication.bitmapUtils.display(viewHolder.iv_actiivty_type, activityTypeBean.getRequestUrl(), R.drawable.home_hot_button);
		} else {
			BaseApplication.bitmapUtils.display(viewHolder.iv_actiivty_type, activityTypeBean.getRequestUrl(), R.drawable.home_await_button);
		}
