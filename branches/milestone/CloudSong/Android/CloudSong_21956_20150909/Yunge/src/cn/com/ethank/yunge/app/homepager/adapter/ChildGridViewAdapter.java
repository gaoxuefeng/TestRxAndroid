...
public class ChildGridViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			gridViewItemHolder.iv_item_bg = (ImageView) convertView.findViewById(R.id.iv_item_bg);
		...
		MyImageLoader.displayImage(gridViewItemHolder.iv_item_bg, activityBean.getActivityImageUrl(), R.drawable.home_defaultimg_bg);
