...
package cn.com.mining.app.zxing.camera;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width = screenResolution.x * 17 / 32;
			int height = screenResolution.x * 17 / 32;

			int leftOffset = (screenResolution.x - width) / 2;
			int topOffset = (screenResolution.y) * 270 / 1136;
	...
	public boolean getSupportLight() {
		if (camera != null) {
			Parameters parameter = camera.getParameters();
			List<String> str = parameter.getSupportedFlashModes();
			if (str != null) {
				return true;
			}
		}
