...
public class MyRoomAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.iv_userhead = (cn.com.ethank.yunge.app.util.XCRoundImageViewByXfermode) convertView.findViewById(R.id.iv_userhead);
		...
		MyImageLoader.displayImage(holder.iv_userhead, myRoomInfoBean.getReservationAvatarUrl(), R.drawable.sing_default_head);
