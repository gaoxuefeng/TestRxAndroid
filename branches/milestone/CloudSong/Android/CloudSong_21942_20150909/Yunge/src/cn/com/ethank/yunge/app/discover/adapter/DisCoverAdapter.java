...
public class DisCoverAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		MyImageLoader.displayImage(holder.img, bean.getMusicPhotoUrl(), R.drawable.find_deflaut_bg);
		MyImageLoader.displayImage(holder.dis_img_small, bean.getAvatarUrl(), R.drawable.mine_defaultavatar);
