...
public class AcyivityByTypeListAdapter extends BaseAdapter {
	...
	private void initConvertViewData(int position, View convertView, final ViewHolder viewHolder) {
		...
		MyImageLoader.displayImage(viewHolder.iv_activiti_image, activityBean.getActivityImageUrl(), R.drawable.home_defaultimg_bg);
		MyImageLoader.displayImage(viewHolder.iv_hot_type, activityBean.getTypeImageUrl());
		MyImageLoader.displayImage(viewHolder.iv_activitydengji_id, activityBean.getActivityIcon());
