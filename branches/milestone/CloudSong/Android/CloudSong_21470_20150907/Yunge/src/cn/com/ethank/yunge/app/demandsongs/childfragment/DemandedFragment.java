...
public class DemandedFragment extends BaseFragment {
	...
	private void registBroadCastReceive() {
		try {
			...
			filter.addAction(Constants.NEXT_SONG_UPDATE_RECEIVE);
	...
	class SongChangeReceive extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			try {
				if ((action.equals(YungeJPushType.getAction(YungeJPushType.changeSong)) || action.equals(Constants.NEXT_SONG_UPDATE_RECEIVE))
						&& Constants.isBinded()) {
					getNetData(true);
