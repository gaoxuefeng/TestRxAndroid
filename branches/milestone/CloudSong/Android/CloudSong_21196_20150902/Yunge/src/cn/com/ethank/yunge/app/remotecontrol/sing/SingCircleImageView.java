 ...
 */
public class SingCircleImageView extends ImageView {
	 ...
	 * @param context
	 */
	public SingCircleImageView(Context context) {
		this(context, null);
	}
	 ...
	 * @param attrs
	 */
	public SingCircleImageView(Context context, AttributeSet attrs) {
	 ...
	 * @param defStyle
	 */
	public SingCircleImageView(Context context, AttributeSet attrs, int defStyle) {
