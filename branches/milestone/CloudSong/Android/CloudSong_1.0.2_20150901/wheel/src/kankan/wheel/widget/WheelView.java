...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { R.color.pre_time, R.color.pre_time, R.color.pre_time };

	private static final int[] DONESHADOWS_COLORS = new int[] { Color.TRANSPARENT, Color.TRANSPARENT, Color.TRANSPARENT };
	...
	private static final int DEF_VISIBLE_ITEMS = WheelViewConstantUtils.VISIBLE_ITEMS;
	...
	private void initResourcesIfNecessary() {
		...
		if (!WheelViewConstantUtils.ISVISIBLECENTERLINE) {// DONESHADOWS_COLORS
			if (centerDrawable == null) {
				centerDrawable = getContext().getResources().getDrawable(R.drawable.donewheel_val);
			}
			if (topShadow == null) {
				topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, DONESHADOWS_COLORS);
			}
			if (bottomShadow == null) {
				bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, DONESHADOWS_COLORS);
			}
		} else { 
			if (centerDrawable == null) {
	...
	private void drawShadows(Canvas canvas) {
		...
		topShadow.setVisible(WheelViewConstantUtils.ISVISIBLECENTERLINE, false);
		bottomShadow.setVisible(WheelViewConstantUtils.ISVISIBLECENTERLINE, false);
	}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setVisible(WheelViewConstantUtils.ISVISIBLECENTERLINE, false);
	}
	...
	private View getItemView(int index) {
		...
		view.setMinimumHeight(WheelViewConstantUtils.ITEMHEIGHT);
