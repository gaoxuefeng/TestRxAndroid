...
public class DisCoverAdvertImagePagerAdapter extends RecyclingPagerAdapter {
	...
	public View getView(int position, View view, ViewGroup container) {
		...
		if (holder.imageView.getTag() != null) {
			if (!holder.imageView.getTag().equals(discoverSubjectBean.getSpecialImgPath())) {
				Bitmap bitmap = pictureManager.getmenuLogo(discoverSubjectBean.getSpecialImgPath(), false, downloadFinished);
				if (bitmap != null) {
				...
				holder.imageView.setTag(discoverSubjectBean.getSpecialImgPath());
			}
		} else {
			Bitmap bitmap = pictureManager.getmenuLogo(discoverSubjectBean.getSpecialImgPath(), false, downloadFinished);
			if (bitmap != null) {
