...
public class DisCoverAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (bean != null && holder.img.getTag() != null && bean == holder.img.getTag()) {
			return convertView;
		}
		Bitmap bm1 = pictureManager.getmenuLogo(bean.getMusicPhotoUrl(), false, downloadFinished);
		if (bm1 != null) {
			holder.img.setImageBitmap(bm1);
		}

		Bitmap bm2 = pictureManager.getmenuLogo(bean.getAvatarUrl(), false, downloadFinished);
		if (bm2 != null) {
