...
//		mController.setShareMedia(new UMImage(context,R.drawable.ic_launch));
		...
		sinaShareContent.setShareContent("小伙伴们,赶紧来听听"+discoverInfo.getUserNickName()+"唱的《"+discoverInfo.getMusicName()+"》吧,TA马上就要变成歌神啦！你还在等什么,赶快来挑战吧！"+discoverInfo.getShareUrl()+"?id="+discoverInfo.getDiscoverId());
...
//		weixinContent.setShareContent("我在潮趴汇上预订了一个"+shopname+"活动,诚邀各位参与,http://www.baidu.com");
		weixinContent.setShareContent("小伙伴们,赶紧来听听"+discoverInfo.getUserNickName()+"唱的《"+discoverInfo.getMusicName()+"》吧,TA马上就要变成歌神啦！你还在等什么,赶快来挑战吧！");
		// 设置title
...
//		circleMedia.setShareContent("我在潮趴汇上预订了一个"+shopname+"活动,诚邀各位参与,http://www.baidu.com");
		circleMedia.setShareContent("小伙伴们,赶紧来听听"+discoverInfo.getUserNickName()+"唱的《"+discoverInfo.getMusicName()+"》吧,TA马上就要变成歌神啦！你还在等什么,赶快来挑战吧！");
		// 设置朋友圈title
//		circleMedia.setTitle("潮趴汇KTV主题活动邀请函");
		...
		UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(context, "1104563078",
				"M9mZnpH8RuxYn3uD");
...
//		qqShareContent.setShareContent("我在潮趴汇上预订了一个"+shopname+"活动,诚邀各位参与,http://www.baidu.com");
		qqShareContent.setShareContent("小伙伴们,赶紧来听听"+discoverInfo.getUserNickName()+"唱的《"+discoverInfo.getMusicName()+"》吧,TA马上就要变成歌神啦！你还在等什么,赶快来挑战吧！");
		// 设置分享title
