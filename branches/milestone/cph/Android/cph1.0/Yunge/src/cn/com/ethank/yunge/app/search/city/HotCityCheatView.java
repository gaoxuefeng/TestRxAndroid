...
public class HotCityCheatView extends LinearLayout {
	...
	private void initCity(Context context) {
		 ...
		 Pair<String, List<String>> hotCityPair = new Pair<String, List<String>>("热门城市", Arrays.asList(hotCitys));
//		Pair<String, List<String>> hotCityOuterPair = new Pair<String, List<String>>("海外热门目的地", Arrays.asList(hotOutSeaCity));
