...
public class ImageHandler extends Handler {
	...
	private WeakReference<MerchantDetailFragment> weakReference;
	private int currentItem = 0;

	public ImageHandler(WeakReference<MerchantDetailFragment> wk) {
		weakReference = wk;
	}
	...
	public void handleMessage(Message msg) {
		...
		MerchantDetailFragment activity = weakReference.get();
		if (activity == null) {
