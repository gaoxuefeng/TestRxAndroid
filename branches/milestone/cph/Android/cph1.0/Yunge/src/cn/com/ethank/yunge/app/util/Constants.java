...
public class Constants {
	...
	// 已点未唱
	public static final String CHANGE_VIEWPAGERPOSITION = "cn.com.ethank.yunge.CHANGE_MAINTAB_VIEWPAGER_POSITION";// 切换首页 tab
	...
	public static final String REQUEST_ACTIVITY_BY_TYPE_LIST = "home/activities/get.json";// 根据语言获取歌曲列表
	...
	// "http://202.142.16.98:9002/ethank-yungepay/yunpay/";
	public static final String ALIPAYUrl = "http://yungepay.ethank.com.cn/ethank-yungepay/yunpay/";

	//
	// public static String hostUrlKTV_ = getKTVIP();

	// public static final String hostUrlCloud =
	// "http://192.168.1.121:8080/ethank-yunge-deploy/";// 服务器
	public static final String hostUrlCloud = "http://yunge.ethank.com.cn/ethank-yunge-deploy/";// 服务器
