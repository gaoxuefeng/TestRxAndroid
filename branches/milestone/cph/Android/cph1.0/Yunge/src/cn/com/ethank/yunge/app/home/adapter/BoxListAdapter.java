...
public class BoxListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (boxInfos.get(position).isBoxTypeState()) {
			holder.item_but_pre.setBackground(context.getResources().getDrawable(R.drawable.pre_shape));
			...
			holder.item_but_pre.setBackground(context.getResources().getDrawable(R.drawable.pre_shape_gray));
		}
