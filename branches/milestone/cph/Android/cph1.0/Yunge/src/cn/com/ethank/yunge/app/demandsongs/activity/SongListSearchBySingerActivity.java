...
public class SongListSearchBySingerActivity extends BaseTitleActivity {
	...
	private void requestData() {
		...
		String url =Constants.REQUEST_SONG_BY_SINGER_ID_URL;
	...
	private void initView() {
		...
		if (bundle.containsKey("className")) {
			...
			if (className != null && !className.isEmpty()) {
				...
				title.setBtnBackText("歌手");
			}
			if (bundle.containsKey("singlerBean")) {
				singlerBean = (SinglerOnLine) bundle.getSerializable("singlerBean");
			}
