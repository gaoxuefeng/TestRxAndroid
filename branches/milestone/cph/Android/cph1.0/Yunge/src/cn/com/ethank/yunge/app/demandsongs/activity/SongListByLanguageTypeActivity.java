...
public class SongListByLanguageTypeActivity extends BaseTitleActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_song_list_language_type);
	...
	private void requestData() {
		...
		hashMap.put("type", languageBean.getType());
		String url = Constants.REQUEST_LANGUAGE_SONG_LIST;
	...
	private void initView() {
		...
		if (bundle.containsKey("languageBean")) {
			languageBean = (LanguageBean) bundle.getSerializable("languageBean");
			title.setTitle(languageBean.getLanguageName());
			title.setBtnBackText("语种");
		} else {
			languageBean = new LanguageBean();
			languageBean.setType("1");// 默认国语
